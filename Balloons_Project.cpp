...
const float KB_SPEED = 0.35; //Speed of balloons
...
int main()
{
    ...
    Texture redTex;
    LoadTex(redTex, "images/rubber_duck.png");
    ...
    for (int i(0); i < 5; i++) {
        ...
        balloon.setVelocity(Vector2f(KB_SPEED, 0));
        ...
        balloon.onCollision =
            ...
            if (result.object2 == right) {
                ...
                //world.RemovePhysicsBody(balloon);
                //balloons.QueueRemove(balloon);
                Vector2f sz2 = balloon.getSize();
                //cout << sz2.y;
                balloon.setCenter(Vector2f(50, 20 + (sz2.y / 2)));
